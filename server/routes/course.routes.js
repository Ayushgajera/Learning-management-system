...
import { createCourse, createLectures, editCourse, editLecture, getAllCourses, getAllLectures, getCourseById, getLectureById, getMonthlyRevenue, getPublishCourse, publishCourse, removeCourse, removeLecture, addRating, getTopCourses, getCourseReviews } from '../controllers/course.controller.js';
...
router.route("/ranking").get(getTopCourses); // Public route for top ranked courses
router.route("/:courseId/reviews").get(getCourseReviews); // Public route for fetching reviews
...
router.route("/:courseId/rate").post(isAuthenticated, addRating);

...
// Admin/Instructor specific menu items
const menuItems = [
  {
    to: "/admin/dashboard",
  ...
  },
  {
    ...
    label: "My Courses",
    badge: { content: "12", className: "px-2 py-0.5 text-xs bg-indigo-500/15 text-indigo-700 font-semibold rounded-full" }
  },
  {
    to: "/admin/users",
    icon: <FiUsers className="w-4 h-4 text-slate-500 dark:text-slate-300 group-hover:text-indigo-500" />,
    label: "Students",
      ...
      return (
        <div className="hidden md:flex items-center space-x-4">
          ...
          <button
            ...
            disabled={loading}
            className="flex items-center gap-2 px-4 py-2 rounded-full font-semibold border-2 border-indigo-500 text-indigo-600 dark:text-indigo-400 hover:bg-indigo-50 dark:hover:bg-indigo-500/10 transition-all duration-200"
          >
            <FiUsers className="w-4 h-4" />
            <span>{loading ? 'Switching...' : 'Switch to Student'}</span>
          </button>
          ...
          <div className="relative" ref={dropdownRef}>
            ...
            >
              ...
              <div className="hidden lg:flex flex-col items-start">
                ...
                <span className="text-xs font-medium text-indigo-600 dark:text-indigo-400 capitalize">{userData?.role || 'Instructor'}</span>
              </div>
            </button>
            <AnimatePresence>
        ...
        <div className="mx-auto flex h-16 w-full max-w-[1380px] items-center justify-between gap-4">
          ...
          <div className="flex items-center md:hidden">
            <button
              ...
              className="p-2 rounded-lg text-gray-600 hover:text-indigo-600 hover:bg-gray-100 focus:outline-none"
            >
              ...
              {userData && (
                <div className="flex items-center space-x-3">
                  <img
                    src={userData?.photoUrl || "https://images.unsplash.com/photo-1633332755192-727a05c4013d?q=80&w=1480&auto=format&fit=crop"}
                    alt={userData?.name || "User"}
                    className="h-12 w-12 rounded-full ring-2 ring-indigo-500 ring-offset-2 ring-offset-white object-cover"
                  />
                  <div>
                ...
                {userData ? (
                  <>
                    ...
                    >
                      ...
                      <span className="flex-1 font-medium">{loading ? 'Switching...' : 'Switch to Student View'}</span>
                    </button>
                  ...
                  <>
                    ...
                    <Link to="/register" className="w-full block text-center bg-indigo-500 text-white hover:bg-indigo-600 px-4 py-2 rounded-lg">
                      <span>Sign Up</span>
                    </Link>
                  </>
                )}

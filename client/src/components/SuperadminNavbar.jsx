...
import { FiHome, FiUser, FiUsers, FiBook, FiBarChart2, FiSettings, FiLogOut, FiMoon, FiSun, FiLayers, FiShield, FiBookOpen } from 'react-icons/fi';
import { useSelector, useDispatch } from 'react-redux';
import { useLogoutUserMutation } from '@/features/api/authApi';
import { userLoggedOut } from '@/features/authslice';
import { ThemeContext } from '@/extensions/ThemeProvider';

// Superadmin: Only show short, important menu items on top navbar
const menuItems = [
  {
...
// Helper: add padding to body to prevent overlap


// RECOMMENDATION: In your main layout or each superadmin page, add 'pt-16' (or 'pt-[64px]') to the main container to prevent navbar overlap.
          ...
          <div className="relative" ref={dropdownRef}>
            ...
            >
              ...
              <div className="hidden lg:flex flex-col items-start">
                ...
                <span className="text-xs font-medium text-indigo-600 dark:text-indigo-400 capitalize">Superadmin</span>
              </div>
            </button>
            <AnimatePresence>
        ...
        <div className="mx-auto flex h-16 w-full max-w-[1380px] items-center justify-between gap-4">
          ...
          <div className="flex items-center">
            <Link to="/" className="flex items-center space-x-2">
              <FiLayers className="w-7 h-7 text-indigo-500" />
              <motion.div
